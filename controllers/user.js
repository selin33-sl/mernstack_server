...
export const updatePic = asyncError(async (req, res, next) => {
  ...
  // önceki image bulutundan imageyi siliyoruz.
...
export const resetpassword = asyncError(async (req, res, next) => {
  ...
  if (!user)
    return next(new Errorhandler("Incorrenct OTP or has been expired", 400));
